...
import { Shield, Lock, Eye, Mail, ChevronRight, Home } from 'lucide-react';

const BASE_URL = 'https://hellotools.net';

export const metadata: Metadata = {
  title: 'Privacy Policy',
  description: 'HelloTools privacy-first policy. Learn how all calculations run locally in your browser with zero data logging, no account setup, and full privacy.',
  alternates: {
    canonical: `${BASE_URL}/privacy`,
  },
  openGraph: {
    title: 'Privacy Policy | HelloTools',
    description: 'Learn how all calculations run locally in your browser with zero data logging, no account setup, and full privacy.',
